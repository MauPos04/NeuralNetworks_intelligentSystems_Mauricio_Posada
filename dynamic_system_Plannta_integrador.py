...
class MassDamper:
    def __init__(self):
        ...
        xg = xgb(10)
        self.model = xg.load_model(name = 'Proyectosubnormal_PID',inputs =  7, alfa = 0.02)
    ...
    def system_equations(self, t, y):
        ...
        dvdt = -(self.k+self.k2/self.m) * x - (self.b/self.m) * v + self.U/self.m + (self.k2*self.y2)/self.m
        return [dxdt, dvdt]
    ...
    def run_simulation(self):
        ...
        for i in range(1, len(t)):
            ...
            self.U = self.inverse_neuronal_control(control_vector, U[i-1])*8
        ...
        excel_filename = 'ProyectoSubnormal_PID.xlsx'
